...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-mysterio-purple/20 rounded-full blur-[80px] animate-float" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 glass-card p-6 rounded-xl max-w-xs backdrop-blur-md animate-float" style={{ animationDelay: '1.5s' }}>
